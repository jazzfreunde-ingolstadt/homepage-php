...
namespace Jazzfreunde\App\Service\EmailConfirmation;
...
final class EmailConfirmationService implements LoggerAwareInterface
{
     ...
     */
    public function __construct(private ManagerRegistry $doctrine, private MailerInterface $mailer, private UrlGeneratorInterface $urlGenerator)
    {
    }
     ...
     */
    public function askForConfirmation(string $email, ): void
    {
        /**
