...
<table id="introtableau" border="0" cellspacing="0" cellpadding="0" align="center" valign="middle">
  <tbody>
    <tr id="intro_upperlinkline" class="splash_text">
      <td><a id="txt_1a" href="/newsletter" title="Newsletter" onmouseover="swap('1a', true)" onmouseout="swap('1a', false)">Newsletter &amp; Aktuelles</a></td>
      <td><a id="txt_1b" href="/ueberuns" title="Über uns" onmouseover="swap('1b', true)" onmouseout="swap('1b', false)">Über uns</a></td>
    ...
    <tr id="intro_lowerlinkline" class="splash_text">
      ...
      <td><a id="txt_2b" href="/projekte" title="Projekte" onmouseover="swap('2b', true)" onmouseout="swap('2b', false)">Projekte</a></td>
      <td><a id="txt_2c" href="/termine" title="Veranstaltungen" onmouseover="swap('2c', true)" onmouseout="swap('2c', false)">Veranstaltungen</a></td>
    </tr>
    <tr id="intro_logotext">
      <td colspan="3" align="center"><a href="ueberuns"><img src="/gfx/jazzlogotext.png" style="margin:0.5em;" alt="JazzFreunde Ingolstadt e.V." width="190" height="50" border="0" /></a></td>
    </tr>
  </tbody>
</table>
