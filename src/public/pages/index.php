...
<table id="introtableau" border="0" cellspacing="0" cellpadding="0" align="center" valign="middle">
  <tbody>
    ...
    <tr id="intro_upperimgline" class="splash_img">
      <td><a href="newsletter.php" title="Newsletter" onmouseover="swap('1a', true)" onmouseout="swap('1a', false)"><img id="img_1a" src="<?=img("1a") ?>" alt="" width="250" height="150" border="0" /></a></td>
      <td><a href="ueberuns.php" title="Über uns" onmouseover="swap('1b', true)" onmouseout="swap('1b', false)"><img id="img_1b" src="<?=img("1b") ?>" alt="" width="250" height="150" border="0" /></a></td>
      <td><a href="beitritt.php" title="Mitglied werden" onmouseover="swap('1c', true)" onmouseout="swap('1c', false)"><img id="img_1c" src="<?=img("1c") ?>" alt="" width="250" height="150" border="0" /></a></td>
    </tr>
    <tr id="intro_lowerimgline" class="splash_img">
      <td><a href="ziele.php" title="Ziele" onmouseover="swap('2a', true)" onmouseout="swap('2a', false)"><img id="img_2a" src="<?=img("2a") ?>" alt="" width="250" height="150" border="0" /></a></td>
      <td><a href="projekte.php" title="Projekte" onmouseover="swap('2b', true)" onmouseout="swap('2b', false)"><img id="img_2b" src="<?=img("2b") ?>" alt="" width="250" height="150" border="0" /></a></td>
      <td><a href="termine.php" title="Veranstaltungen" onmouseover="swap('2c', true)" onmouseout="swap('2c', false)"><img id="img_2c" src="<?=img("2c") ?>" alt="" width="250" height="150" border="0" /></a></td>
    </tr>
...
<script type="text/javascript">
  ...
  function swap(nr, state) {
    ...
    img.src = 'gfx/start_<?=$c ?>/start_' + nr + '_' + (state ? 'hl' : 'ul') + '.png';
