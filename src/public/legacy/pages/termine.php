...
?>
	<tr <?= $tdstyle ?>>
		...
		<td>
			<?= ($imgid == null || $imgid == "0" || $imgid < 0 || $imgid == "" ? "<img src=\"/gfx/empty.png\" height=\"32\" width=\"32\" border=\"0\" alt=\"\" />" : "<a href=\"/bilderbilder=" . $imgid . "&amp;via=" . PAGE . "\" title=\"Zu den Bildern\"><img src=\"/gfx/dia.png\" height=\"32\" width=\"32\" border=\"0\" alt=\"Bilder\" /></a>") ?>
		</td>
		<td>
